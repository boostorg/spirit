...
#define BOOST_SLEX_DEBUG (BOOST_SPIRIT_DEBUG_FLAGS & BOOST_SPIRIT_DEBUG_FLAGS_SLEX)
            ...
            BOOST_SPIRIT_TRACE_RULE(regex, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(re, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(series, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(singleton, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(singleton2, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(fullccl, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(ccl, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(string, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(escseq, BOOST_SLEX_DEBUG);
            BOOST_SPIRIT_TRACE_RULE(ccl_char, BOOST_SLEX_DEBUG);
...
lexer<IteratorT, TokenT, CallbackT>::lexer(unsigned int states)
    ...
    , m_num_states(states)
{
    BOOST_SPIRIT_TRACE_NODE_NAME(g, "slex::lexer", 
