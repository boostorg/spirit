...
//    }
    ...
    {
//        typedef type_sequence<boost::mpl::vector_c<int, 1, 2, 3> > v1_type;
//        v1_type v1;
//        int i0 = *begin(v1);


////        typedef type_sequence<boost::mpl::vector_c<int, 4, 5, 6> > v2_type;
////        typedef joint_view<v1_type, v2_type> join_type;
//        v1_type v1;
////        v2_type v2;
//
////        join_type j(v1, v2);
...
//
//
////        std::cout << generate(join_type(v1, v2)) << std::endl;
//
////        std::cout << join_type(v1, v2) << std::endl;
    }
